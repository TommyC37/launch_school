...
string is a numeric string between 0 and 255 as required for IP numbers and asked 
Ben to use it. Below is the code that Ben wrote.
...
function isDotSeparatedIpAddress(inputString) {
  ...
  if (inputString.match(/\./g).length === 3) {
...
console.log(isDotSeparatedIpAddress("192.0.2.1"));